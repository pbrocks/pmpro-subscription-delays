 ...
 * Plugin URI: https://www.paidmembershipspro.com/wp/pmpro-subscription-delays/
...
/**
 * TODO: Save the subscription start date to usermeta after checkout and filter pmpro_next_payment_date to use that value if it’s not in the past.
 */
...
function pmprosd_pmpro_profile_start_date( $start_date, $order ) {
	...
	if ( ! empty( $order->discount_code ) ) {
		 ...
		 * [$subscription_delay description]
		 *
		 * @var [type]
		 */
 ...
 * @since .4
 *
 * [pmprosd_pmpro_next_payment description]
 ...
 *
 * [pmprosd_daysUntilDate description]
 *
 ...
 * [pmprosd_pmpro_discount_code_level description]
 *
 * @param  [type] $level   [description]
 * @param  [type] $code_id [description]
 * @return [type]          [description]
 ...
 * [pmprosd_level_cost_text description]
 *
 ...
 * [pmpro_saveDCSDs description]
 *
 * @param  [type] $code_id [description]
 * @param  [type] $delays  [description]
 * @return [type]          [description]
 */
 ...
 * [pmprosd_pmpro_subscribe_order description]
 *
 * @param  [type] $order   [description]
 ...
 * [pmprosd_plugin_row_meta description]
 *
...
function pmprosd_plugin_row_meta( $links, $file ) {
	if ( strpos( $file, 'pmpro-subscription-delays.php' ) !== false ) {
		$new_links = array(
			'<a href="' . esc_url( 'https://www.paidmembershipspro.com/add-ons/plugins-on-github/subscription-delays/' ) . '" title="' . esc_attr( __( 'View Documentation', 'pmpro' ) ) . '">' . __( 'Docs', 'pmpro' ) . '</a>',
